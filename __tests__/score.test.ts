...
describe("Scoring Engine", () => {
  ...
  describe("Test 2: Ten Synthetic Profiles", () => {
    const profiles = [
      { name: "Solo consultant", target: { Leak: 42, Vis: 42, Frag: 17, Score: 33, Band: 1, CostingMost: "fragmentation", AI: null }, fixture: { q1: 1, q2: 5, q3: 2, q4: 1, q5: 1, q6: 3, q7: 1, q8: 5, q9: 2 } as Answers },
      { name: "6-person agency", target: { Leak: 50, Vis: 50, Frag: 25, Score: 42, Band: 2, CostingMost: "fragmentation", AI: 25 }, fixture: { q1: 1, q2: 5, q3: 3, q4: 1, q5: 1, q6: 4, q7: 2, q8: 2, q9: 5, q10: 2, q11: 2 } as Answers },
      { name: "20-person care provider", target: { Leak: 17, Vis: 25, Frag: 8, Score: 17, Band: 1, CostingMost: "fragmentation", AI: null }, fixture: { q1: 1, q2: 2, q3: 2, q4: 1, q5: 1, q6: 2, q7: 1, q8: 1, q9: 4 } as Answers },
      { name: "12-person firm", target: { Leak: 75, Vis: 92, Frag: 75, Score: 81, Band: 4, CostingMost: "leakage", AI: 75 }, fixture: { q1: 3, q2: 5, q3: 4, q4: 2, q5: 5, q6: 5, q7: 5, q8: 4, q9: 5, q10: 4, q11: 4 } as Answers },
      { name: "30-person business", target: { Leak: 33, Vis: 58, Frag: 17, Score: 36, Band: 2, CostingMost: "fragmentation", AI: 27 }, fixture: { q1: 1, q2: 3, q3: 3, q4: 1, q5: 1, q6: 3, q7: 2, q8: 3, q9: 5, q10: 3, q11: 1 } as Answers },
      { name: "Great vis, terrible leak", target: { Leak: 0, Vis: 100, Frag: 50, Score: 50, Band: 3, CostingMost: "leakage", AI: null }, fixture: { q1: 1, q2: 1, q3: 1, q4: 1, q5: 3, q6: 5, q7: 5, q8: 5, q9: 5 } as Answers },
      { name: "Great int, no vis", target: { Leak: 67, Vis: 0, Frag: 100, Score: 56, Band: 3, CostingMost: "visibility", AI: 38 }, fixture: { q1: 3, q2: 5, q3: 3, q4: 5, q5: 5, q6: 5, q7: 1, q8: 1, q9: 1, q10: 3, q11: 2 } as Answers },
      { name: "Systemised solo", target: { Leak: 92, Vis: 83, Frag: 75, Score: 83, Band: 4, CostingMost: "fragmentation", AI: null }, fixture: { q1: 4, q2: 5, q3: 5, q4: 2, q5: 5, q6: 5, q7: 5, q8: 4, q9: 4 } as Answers },
      ...
      { name: "16+ tools integrated", target: { Leak: 75, Vis: 75, Frag: 100, Score: 83, Band: 4, CostingMost: "leakage", AI: 63 }, fixture: { q1: 3, q2: 5, q3: 4, q4: 5, q5: 5, q6: 5, q7: 4, q8: 4, q9: 4, q10: 4, q11: 3 } as Answers },
      { name: "Fully systemised (all top answers)", target: { Leak: 100, Vis: 100, Frag: 100, Score: 100, Band: 5, CostingMost: "leakage", AI: null }, fixture: { q1: 5, q2: 5, q3: 5, q4: 5, q5: 5, q6: 5, q7: 5, q8: 5, q9: 5 } as Answers },
    ];
