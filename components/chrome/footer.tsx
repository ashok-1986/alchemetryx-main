  ...
  return (
    <footer className="w-full relative overflow-hidden section-dark bg-[var(--color-sapphire)] text-[var(--color-pearl)] border-t border-[var(--color-sapphire-line)]/50 px-[1em] lg:px-[2em] py-[2em]">
      ...
      <div className="relative z-10 w-full flex flex-col space-y-16">
        {/* Main Grid: 6 equal columns for Brand, Nav, and Chat */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-[2em] items-start w-full mt-4">
          {/* Column 1: Brand Mark & Mission */}
          ...
          <div className="space-y-4 lg:pl-2">
            <p className="text-xl md:text-2xl font-light tracking-tight text-[var(--color-pearl)] mb-2">
              Let&apos;s chat
            </p>
        ...
        <div className="relative w-full py-4">
          ...
          <div className="absolute top-4 left-0 w-1/3 h-px bg-gradient-to-r from-transparent via-[var(--color-gold)]/30 to-transparent" />
        </div>
